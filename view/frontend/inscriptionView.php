      ...
      <div class="login-page">
        <div  class="form">
          <form method="post" action="index.php" class="login-form">
            ...
            <input type="submit" Value="CREATE" id="bouton" class="creer_Compte"/>
          ...
          <form method="post" action="index.php"  class="register-form" >
            ...
            <input type="password" id="conPass" vname="pass" placeholder="password" /><label id="errConPass"></label>
...
var cmdp = document.getElementById('cmdp');
 ...
 cmdp.addEventListener('focus', function(e) {
    ...
    errcmdp.innerHTML = "mot de soit etre passe identiques !";
